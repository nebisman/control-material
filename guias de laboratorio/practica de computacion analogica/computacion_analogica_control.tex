...
\item Ajuste el generador de onda con una señal cuadrada de $10\,\text{Hz}$. Ajuste la tensión del generador en  $4V_{pp}$. Ajuste el offset en $2\,V$ para que la señal inicie en cero y sincronice apropiadamente el osciloscopio con \textbf{\textcolor{red}{con el acoplamiento de ambos canales en DC!}} Debe obtener la señal mostrada en la figura \ref{fig:ondacuadrada}
%
\begin{figure}[h!]
	\centering
...
\begin{enumerate}
	...
	\item  \textcolor{bitacora}{Encuentre los parámetros $b$ y $a$ de la ecuación~\ref{equ:primorden} para satisfacer los siguientes requerimientos:}
	\begin{itemize}
	...
	\item  Mida el tiempo de subida y la respuesta de estado estacionario.	
